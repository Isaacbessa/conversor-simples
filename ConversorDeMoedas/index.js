...
setInterval(function () {
  ...
  if (de.value == "USD" && para.value == "BRL") {
    if (input.value <= 0) {
      ...
      valor.innerText = (parseFloat(input.value) * 5.42).toFixed(2).replace('.', ',');
      simbolo.innerText = "R$";
    }
  }
  ...
  //Dolar para Euro
    ...
    if (input.value <= 0) {
      ...
      valor.innerText = (parseFloat(input.value) * 0.86).toFixed(2).replace('.', ',');
      simbolo.innerText = "€";
    }
  }
  ...
  //Real para Euro
    ...
    if (input.value <= 0) {
      ...
      valor.innerText = (parseFloat(input.value) * 0.16).toFixed(2).replace('.', ',');
      simbolo.innerText = "€";
    }
  }
  ...
  //Euro para dolar
    ...
    if (input.value <= 0) {
      ...
      valor.innerText = (parseFloat(input.value) * 1.16).toFixed(2).replace('.', ',');
      simbolo.innerText = "$";
    }
  }
  ...
  //Euro para Real
    ...
    if (input.value <= 0) {
      ...
      valor.innerText = (parseFloat(input.value) * 6.28).toFixed(2).replace('.', ',');
      simbolo.innerText = "R$";
    }
  }
